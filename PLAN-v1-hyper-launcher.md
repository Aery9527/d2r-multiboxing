...
├── cmd/
│   └── d2r-hyper-launcher/
│       └── [main.go](cmd/d2r-hyper-launcher/main.go)   # 程式進入點，CLI 互動主迴圈
├── [go.mod](go.mod)
├── go.sum
│
├── internal/
...
### `cmd/d2r-hyper-launcher/main.go` - CLI 主程式
...
- [x] 1.1 清理 [main.go](cmd/d2r-hyper-launcher/main.go) 中的 GoLand 範本程式碼
